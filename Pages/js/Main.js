    ...
    columnDefs: [
        {
            ...
            render: function (data) {
                return `<div class="left"><span class="dot_${data[5]}">$</span><a href="${detailPage}?id=${data[1]}" >${data[0]}</br>${isAdmin ? data[2] : data[3]}</a></div>`;
            }
        },
        {
            title: l('Location'),
...
const promptHTML = function (message, title) {
    Swal.fire({
        title: title,
